       ...
       // } else {
        ...
        <div class="player">
            ...
            <audio id="player" controls="controls">
                <source id="mp3_src" src="<?php echo $package->preview_links->{$tracks[0]->uid};?>" type="audio/mp3" />
...
<footer class="mindsonfire">
    <div class="logo">
        <img src="<?php echo get_template_directory_uri();?>/img/minds_on_fire_logo.png" />
    </div>
    <div class="social">
